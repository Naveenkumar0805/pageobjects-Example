...
public class excelnobroker {
	...
	public void openwebsite() throws InterruptedException {
        ...
        sheet = workbook.createSheet("RentalProperties");
	...
	public void getValues() throws InterruptedException {
		...
		for (WebElement article : articleElements) {
	        ...
	        writeToExcel("GetValues", propertyType, rent, deposit, builtUp, furnishingType);
	...
	public void sortbyoldestfirst() throws InterruptedException {
		...
		for (WebElement article : articleElements) {
			...
			System.out.println("-------******-----------");
	        writeToExcel("SortByOldestFirst", propertyType, rent, deposit, builtUp, furnishingType);
		...
		public void sortbyrent() throws InterruptedException {
			...
			for (WebElement article : articleElements) {
				...
				System.out.println("-------******-----------");
		        writeToExcel("SortByRent", propertyType, rent, deposit, builtUp, furnishingType);

			}

			}
		
		private void writeToExcel(String testName, String propertyType, String rent, String deposit, String builtUp, String furnishingType) {
